...
in
{
  options.my.desktop = {
    ...
    base16Scheme = lib.mkOption {
      type = lib.types.path;
      default = "${pkgs.base16-schemes}/share/themes/onedark.yaml";
      defaultText = lib.literalExpression ''"''${pkgs.base16-schemes}/share/themes/onedark.yaml"'';
      description = "base16 color scheme path for Stylix.";
    };
  };
